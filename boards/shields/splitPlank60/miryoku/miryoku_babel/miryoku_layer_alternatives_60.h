...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NU,                    U_NU,  U_NA,                 &u_to_U_NAV,       &u_to_U_NUM,       &kp RALT,          &studio_unlock,    \
...
&studio_unlock,    &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              U_NU,                    U_NU,  U_RDO,                U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
&studio_unlock,    &kp RALT,          &u_to_U_NUM,       &u_to_U_NAV,       U_NA,              U_NU,                    U_NU,  &kp HOME,             &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,           \
U_NU,              U_NU,              U_NA,              U_NA,              U_NA,              U_NU,                    U_NU,  &kp RET,              &kp BSPC,          &kp DEL,           U_NU,              U_NU

#define MIRYOKU_ALTERNATIVES_NAV \
U_NU,              U_NU,              U_NU,              U_NU,               &u_to_U_BASE,      &u_to_U_GAME,            U_NU,  U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,              \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW, &u_to_U_BASE_FROW, U_NA,                    U_NU,  U_RDO,                U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,          &kp LSHFT,         U_NA,                    U_NU,  &u_caps_word,         &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_NUM_FROW,   &u_to_U_NAV_FROW,  U_NA,                    U_NU,  &kp INS,              &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           \
U_NU,              U_NU,              U_NU,              U_NA,               U_NA,              U_NA,                    U_NU,  &kp RET,              &u_bspc_del,       &kp DEL,           U_NU,              U_NU

#define MIRYOKU_ALTERNATIVES_NAV_INVERTEDT_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,                    &u_to_U_GAME, &u_to_U_BASE,           U_NU,               U_NU,              U_NU,              U_NU,    \
U_NU,              &kp PG_UP,         &kp HOME,          &kp UP,            &kp END,           &kp INS,                 U_NA,         &u_to_U_BASE_FROW,      &u_to_U_EXTRA_FROW, &u_to_U_TAP_FROW,  U_BOOT,            U_NU,    \
U_NU,              &kp PG_DN,         &kp LEFT,          &kp DOWN,          &kp RIGHT,         &u_caps_word,            U_NA,         &kp LSHFT,              &kp LCTRL,          &kp LALT,          &kp LGUI,          U_NU,    \
U_NU,              U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,                   U_NA,         &u_to_U_NAV_FROW,       &u_to_U_NUM_FROW,   &kp RALT,          &studio_unlock,    U_NU,    \
U_NU,              U_NU,              U_NU,              &kp DEL,           &kp BSPC,          &kp RET,                 U_NA,         U_NA,                   U_NA,               U_NU,              U_NU,              U_NU
 
#define MIRYOKU_ALTERNATIVES_NAV_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,                    &u_to_U_GAME, &u_to_U_BASE,           U_NU,               U_NU,              U_NU,              U_NU,    \
U_NU,              &kp HOME,          &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,                 U_NA,         &u_to_U_BASE_FROW,      &u_to_U_EXTRA_FROW, &u_to_U_TAP_FROW,  U_BOOT,            U_NU,    \
U_NU,              &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,            U_NA,         &kp LSHFT,              &kp LCTRL,          &kp LALT,          &kp LGUI,          U_NU,    \
U_NU,              U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,                   U_NA,         &u_to_U_NAV_FROW,       &u_to_U_NUM_FROW,   &kp RALT,          &studio_unlock,    U_NU,    \
U_NU,              U_NU,              U_NU,              &kp DEL,           &kp BSPC,          &kp RET,                 U_NA,         U_NA,                   U_NA,               U_NU,              U_NU,              U_NU
 
#define MIRYOKU_ALTERNATIVES_NAV_INVERTEDT_FROW \
U_NU,              U_NU,              U_NU,              U_NU,               &u_to_U_BASE,      &u_to_U_GAME,           U_NU,  U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,              \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW, &u_to_U_BASE_FROW, U_NA,                   U_NU,  &kp INS,              &kp HOME,          &kp UP,            &kp END,           &kp PG_UP,         \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,          &kp LSHFT,         U_NA,                   U_NU,  &u_caps_word,         &kp LEFT,          &kp DOWN,          &kp RIGHT,         &kp PG_DN,         \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_NUM_FROW,   &u_to_U_NAV_FROW,  U_NA,                   U_NU,  U_RDO,                U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NU,              U_NU,              U_NU,              U_NA,               U_NA,              U_NA,                   U_NU,  &kp RET,              &kp BSPC,          &kp DEL,           U_NU,              U_NU
 
#define MIRYOKU_ALTERNATIVES_NAV_VI_FROW \
U_NU,              U_NU,              U_NU,              U_NU,               &u_to_U_BASE,      &u_to_U_GAME,          U_NU,  U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,              \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW, &u_to_U_BASE_FROW, U_NA,                  U_NU,  U_RDO,                U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,          &kp LSHFT,         U_NA,                  U_NU,  &kp LEFT,             &kp DOWN,          &kp UP,            &kp RIGHT,         &u_caps_word,      \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_NUM_FROW,   &u_to_U_NAV_FROW,  U_NA,                  U_NU,  &kp HOME,             &kp PG_DN,         &kp PG_UP,         &kp END,           &kp INS,           \
U_NU,              U_NU,              U_NU,              U_NA,               U_NA,              U_NA,                  U_NU,  &kp RET,              &kp BSPC,          &kp DEL,           U_NU,              U_NU
...
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_NU,                    U_NU,         U_NA,                 &u_to_U_MOUSE,     &u_to_U_SYM,       &kp RALT,          &studio_unlock,   \
...
&studio_unlock,    &kp RALT,          &u_to_U_SYM,       &u_to_U_MOUSE,     U_NA,              U_NU,                    U_NU,  U_WH_L,               U_WH_D,            U_WH_U,            U_WH_R,            U_NU,             \
U_NU,              U_NU,              U_NA,              U_NA,              U_NA,              U_NU,                    U_NU,  U_BTN2,               U_BTN1,            U_BTN3,            U_NU,              U_NU
...
&studio_unlock,    &kp RALT,          &u_to_U_SYM,       &u_to_U_MOUSE,     U_NA,              U_NU,                    U_NU,  U_NU,                 U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,           \
U_NU,              U_NU,              U_NA,              U_NA,              U_NA,              U_NU,                    U_NU,  U_BTN2,               U_BTN1,            U_BTN3,            U_NU,              U_NU

#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,                    &u_to_U_GAME, &u_to_U_BASE,           U_NU,               U_NU,              U_NU,              U_NU,    \
U_NU,              U_WH_U,            U_WH_L,            U_MS_U,            U_WH_R,            U_NU,                    U_NA,         &u_to_U_BASE_FROW,      &u_to_U_EXTRA_FROW, &u_to_U_TAP_FROW,  U_BOOT,            U_NU,    \
U_NU,              U_WH_D,            U_MS_L,            U_MS_D,            U_MS_R,            U_NU,                    U_NA,         &kp LSHFT,              &kp LCTRL,          &kp LALT,          &kp LGUI,          U_NU,    \
U_NU,              U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,                   U_NA,         &u_to_U_NAV_FROW,       &u_to_U_NUM_FROW,   &kp RALT,          &studio_unlock,    U_NU,    \
U_NU,              U_NU,              U_NU,              U_BTN3,            U_BTN1,            U_BTN2,                  U_NA,         U_NA,                   U_NA,               U_NU,              U_NU,              U_NU
 
#define MIRYOKU_ALTERNATIVES_MOUSE_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,                     &u_to_U_GAME, &u_to_U_BASE,           U_NU,               U_NU,              U_NU,              U_NU,    \
U_NU,              U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,            U_NU,                     U_NA,         &u_to_U_BASE_FROW,      &u_to_U_EXTRA_FROW, &u_to_U_TAP_FROW,  U_BOOT,            U_NU,    \
U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            U_NU,                     U_NA,         &kp LSHFT,              &kp LCTRL,          &kp LALT,          &kp LGUI,          U_NU,    \
U_NU,              U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,                    U_NA,         &u_to_U_NAV_FROW,       &u_to_U_NUM_FROW,   &kp RALT,          &studio_unlock,    U_NU,    \
U_NU,              U_NU,              U_NU,              U_BTN3,            U_BTN1,            U_BTN2,                   U_NA,         U_NA,                   U_NA,               U_NU,              U_NU,              U_NU
 
#define MIRYOKU_ALTERNATIVES_MOUSE_INVERTEDT_FROW \
U_NU,              U_NU,              U_NU,              U_NU,               &u_to_U_BASE,      &u_to_U_GAME,            U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,            U_NU,    \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW, &u_to_U_BASE_FROW, U_NA,                    U_NU,                 U_WH_L,            U_MS_U,            U_WH_R,            U_WH_U,          U_NU,    \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,          &kp LSHFT,         U_NA,                    U_NU,                 U_MS_L,            U_MS_D,            U_MS_R,            U_WH_D,          U_NU,    \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_NUM_FROW,   &u_to_U_NAV_FROW,  U_NA,                    U_RDO,                U_PST,             U_CPY,             U_CUT,             U_UND,           U_NU,    \
U_NU,              U_NU,              U_NU,              U_NA,               U_NA,              U_NA,                    U_BTN2,               U_BTN1,            U_BTN3,            U_NU,              U_NU,            U_NU  
 
#define MIRYOKU_ALTERNATIVES_MOUSE_VI_FROW \
U_NU,              U_NU,              U_NU,              U_NU,               &u_to_U_BASE,      &u_to_U_GAME,            U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,            U_NU,   \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW, &u_to_U_BASE_FROW, U_NA,                    U_RDO,                U_PST,             U_CPY,             U_CUT,             U_UND,           U_NU,   \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,          &kp LSHFT,         U_NA,                    U_MS_L,               U_MS_D,            U_MS_U,            U_MS_R,            U_NU,            U_NU,   \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_NUM_FROW,   &u_to_U_NAV_FROW,  U_NA,                    U_WH_L,               U_WH_D,            U_WH_U,            U_WH_R,            U_NU,            U_NU,   \
U_NU,              U_NU,              U_NU,              U_NA,               U_NA,              U_NA,                    U_BTN2,               U_BTN1,            U_BTN3,            U_NU,              U_NU,            U_NU
...
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_SYM_FROW,   &u_to_U_MOUSE_FROW, U_NA,                    U_NU,                 U_WH_L,            U_WH_D,            U_WH_U,            U_WH_R,   U_NU,         \
U_NU,              U_NU,              U_NU,              U_NA,               U_NA,               U_NA,                    U_BTN2,               U_BTN1,            U_BTN3,            U_NU,              U_NU,     U_NU
...
&u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,        U_NU,                    U_NU,          U_NA,                 &u_to_U_MEDIA,     &u_to_U_FUN,       &kp RALT,          &studio_unlock,  \
...
&studio_unlock,    &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              U_NU,                    U_NU,  &u_out_tog,           &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,     \
...
&studio_unlock,    &kp RALT,          &u_to_U_FUN,       &u_to_U_MEDIA,     U_NA,              U_NU,                    U_NU,  &u_bt_sel_0,          &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,      \
U_NU,              U_NU,              U_NA,              U_NA,              U_NA,              U_NU,                    U_NU,  &kp C_STOP,           &kp C_PP,          &kp C_MUTE,        U_NU,              U_NU
...
#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,                    &u_to_U_GAME, &u_to_U_BASE,           U_NU,               U_NU,              U_NU,              U_NU,    \
U_NU,              U_RGB_HUI,         U_RGB_SAI,         &kp C_VOL_UP,      U_RGB_BRI,         U_RGB_TOG,               U_NA,         &u_to_U_BASE_FROW,      &u_to_U_EXTRA_FROW, &u_to_U_TAP_FROW,  U_BOOT,            U_NU,    \
U_NU,              U_RGB_EFF,         &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_EP_TOG,                U_NA,         &kp LSHFT,              &kp LCTRL,          &kp LALT,          &kp LGUI,          U_NU,    \
U_NU,              &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,              U_NA,         &u_to_U_NAV_FROW,       &u_to_U_NUM_FROW,   &kp RALT,          &studio_unlock,    U_NU,    \
U_NU,              U_NU,              U_NU,              &kp C_MUTE,        &kp C_PP,          &kp C_STOP,              U_NA,         U_NA,                   U_NA,               U_NU,              U_NU,              U_NU
 
#define MIRYOKU_ALTERNATIVES_MEDIA_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,                    &u_to_U_GAME, &u_to_U_BASE,           U_NU,               U_NU,              U_NU,              U_NU,    \
U_NU,              U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         U_RGB_TOG,               U_NA,         &u_to_U_BASE_FROW,      &u_to_U_EXTRA_FROW, &u_to_U_TAP_FROW,  U_BOOT,            U_NU,    \
U_NU,              &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,                U_NA,         &kp LSHFT,              &kp LCTRL,          &kp LALT,          &kp LGUI,          U_NU,    \
U_NU,              &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,              U_NA,         &u_to_U_NAV_FROW,       &u_to_U_NUM_FROW,   &kp RALT,          &studio_unlock,    U_NU,    \
U_NU,              U_NU,              U_NU,              &kp C_MUTE,        &kp C_PP,          &kp C_STOP,              U_NA,         U_NA,                   U_NA,               U_NU,              U_NU,              U_NU
 
#define MIRYOKU_ALTERNATIVES_MEDIA_INVERTEDT_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              &u_to_U_BASE,       &u_to_U_GAME,            U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,           U_NU,    \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW,&u_to_U_BASE_FROW,  U_NA,                    U_RGB_TOG,            U_RGB_EFF,         &kp C_VOL_UP,      U_RGB_HUI,         U_RGB_SAI,      U_NU,    \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,          U_NA,                    U_EP_TOG,             &kp C_PREV,        &kp C_VOL_DN,      &kp C_NEXT,        U_RGB_BRI,      U_NU,    \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_FUN_FROW,  &u_to_U_MEDIA_FROW, U_NA,                    &u_out_tog,           &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,    U_NU,    \
U_NU,              U_NU,              U_NU,              U_NA,              U_NA,               U_NA,                    &kp C_STOP,           &kp C_PP,          &kp C_MUTE,        U_NU,              U_NU,           U_NU
 
#define MIRYOKU_ALTERNATIVES_MEDIA_VI_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              &u_to_U_BASE,       &u_to_U_GAME,            U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,           U_NU,    \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW,&u_to_U_BASE_FROW,  U_NA,                    U_RGB_EFF,            U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         U_RGB_TOG,      U_NU,    \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,          U_NA,                    &kp C_PREV,           &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        U_EP_TOG,       U_NU,    \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_FUN_FROW,  &u_to_U_MEDIA_FROW, U_NA,                    &u_bt_sel_0,          &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       &u_out_tog,     U_NU,    \
U_NU,              U_NU,              U_NU,              U_NA,              U_NA,               U_NA,                    &kp C_STOP,           &kp C_PP,          &kp C_MUTE,        U_NU,              U_NU,           U_NU
...
&studio_unlock,    &kp RALT,          &u_to_U_NAV,       &u_to_U_NUM,       U_NA,              U_NU,                    U_NU,  &kp BSLH,             &kp N1,            &kp N2,            &kp N3,            &kp GRAVE,      \
...
&kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp BSLH,          U_NU,                    U_NU,          U_NA,                 &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          &studio_unlock, \
U_NU,              U_NU,              &kp DOT,           &kp N0,            &kp MINUS,         U_NU,                    U_NU,          U_NA,                 U_NA,              U_NA,              U_NU,              U_NU

#define MIRYOKU_ALTERNATIVES_NUM_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              &u_to_U_BASE,       &u_to_U_GAME,           U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,          U_NU,      \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW,&u_to_U_BASE_FROW,  U_NA,                   &kp LBKT,             &kp N7,            &kp N8,            &kp N9,            &kp RBKT,      U_NU,      \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,          U_NA,                   &kp EQUAL,            &kp N4,            &kp N5,            &kp N6,            &kp SEMI,      U_NU,      \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_FUN_FROW,  &u_to_U_MEDIA_FROW, U_NA,                   &kp BSLH,             &kp N1,            &kp N2,            &kp N3,            &kp GRAVE,     U_NU,      \
U_NU,              U_NU,              U_NU,              U_NA,              U_NA,               U_NA,                   &kp MINUS,            &kp N0,            &kp DOT,           U_NU,              U_NU,          U_NU
...
U_NU,              &kp GRAVE,         &kp N1,            &kp N2,            &kp N3,            &kp BSLH,                U_NA,          &u_to_U_NUM_FROW,  &u_to_U_NAV_FROW,  &kp RALT,          &studio_unlock, U_NU,  \
...
&studio_unlock,    &kp RALT,          &u_to_U_MOUSE,     &u_to_U_SYM,       U_NA,              U_NU,                    U_NU,         &kp PIPE,             &kp EXCL,          &kp AT,            &kp HASH,          &kp TILDE,      \
...
&kp TILDE,         &kp EXCL,          &kp AT,            &kp HASH,          &kp PIPE,          U_NU,                    U_NU,          U_NA,                 &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          &studio_unlock, \
U_NU,              U_NU,              &kp LPAR,          &kp RPAR,          &kp UNDER,         U_NU,                    U_NU,          U_NA,                 U_NA,              U_NA,              U_NU,              U_NU

#define MIRYOKU_ALTERNATIVES_SYM_FLIP_FROW \
U_NU,              U_NU,              U_NU,              U_NU,              &u_to_U_BASE,       &u_to_U_GAME,           U_NU,         U_NU,                 U_NU,              U_NU,              U_NU,              U_NU,           \
U_NU,              U_BOOT,            &u_to_U_TAP_FROW,  &u_to_U_EXTRA_FROW,&u_to_U_BASE_FROW,  U_NA,                   &kp LBRC,     &kp AMPS,             &kp ASTRK,         &kp LPAR,          &kp RBRC,          U_NU,           \
U_NU,              &kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,          U_NA,                   &kp PLUS,     &kp DLLR,             &kp PRCNT,         &kp CARET,         &kp COLON,         U_NU,           \
U_NU,              &studio_unlock,    &kp RALT,          &u_to_U_FUN_FROW,  &u_to_U_MEDIA_FROW, U_NA,                   &kp PIPE,     &kp EXCL,             &kp AT,            &kp HASH,          &kp TILDE,         U_NU,           \
U_NU,              U_NU,              U_NU,              U_NA,              U_NA,               U_NA,                   &kp UNDER,    &kp LPAR,             &kp RPAR,          U_NU,              U_NU               U_NU
...
U_NU,              U_NU,              U_NU,              U_NU,              &u_to_U_GAME,      &u_to_U_BASE_FROW,       &u_to_U_GAME,  &u_to_U_BASE_FROW,    U_NU,              U_NU,              U_NU,              U_NU,          \
...
U_NU,              U_NU,              U_NU,              U_NU,              &u_to_U_GAME,      &u_to_U_BASE,            &u_to_U_GAME,         &u_to_U_BASE,      U_NU,              U_NU,              U_NU,     U_NU,       \
